...
public class CalmWangUserServiceImpl implements CalmWangUserServiceI {
    ...
    @Override
    public Integer saveUser(String userName, String userPhone) {
        miaoGeUserDao.saveUser(userName, userPhone);
        Integer userID = miaoGeUserDao.last_insert_id();
        return userID;
    }

    @Override
    public List<CalmWangUserModel> findUserByPhone(String phone){
        //Long startTime = System.currentTimeMillis();
        List<CalmWangUserModel> users = miaoGeUserDao.findUserByPhone(phone);
        //Long endTime = System.currentTimeMillis();
        return users;
    }

    @Override
    public CalmWangUserModel getByPhone(String phone){
        return miaoGeUserDao.getByPhone(phone);
    }
}
